...
def main():
    ...
    cps2d_df = create_tsne_cp_df(tsne_2d.fit_transform(features), indexed_labels, num_points_to_plot)
    ...
    # Create a Dataframe from to store the fitted TSNE components
    cps3d_df = create_tsne_cp_df(tsne_3d.fit_transform(features), indexed_labels, num_points_to_plot)
